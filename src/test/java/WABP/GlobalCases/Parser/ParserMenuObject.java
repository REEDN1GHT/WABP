...
public class ParserMenuObject extends ConnectBD {
    ...
    private static final String MenuFormData = "Create table #MENU (Apps_MenuID Int,MenuNumber VarChar(255),MenuText VarChar(2555),ObjectType int,ObjectName VarChar(255),OpenMode int,\n" +
            ...
            "       Case When P_5.MenuText Is Not Null Then '\\' + P_5.MenuText Else '' End As [Папка],\n" +
            "       R.MenuText As [Имя объекта],\n" +
            "       R.TypeOfObject As [Тип объекта]\n" +
            ...
            "Where R.TypeOfObject IN ('View','Form', 'Report', 'Table')\n" +
            "drop table #MENU";
