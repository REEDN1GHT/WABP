...
public class Заключения_на_возврат_поступлений_03222_51ЮA extends Driver {
    ...
    @Test
    @Description("Сохранение: Ввод заключений на возврат поступлений 03222")
    public void SaveDoc() throws InterruptedException {
        Auth.AuthWABP();
        NovToForm.NovigateTo("51ЮA");
        initElement();

        //------------------------------
        inputLS.sendKeys("0010000");
        ...
        //-----------------------------
        currentAccount.sendKeys("03224643400000007200");
        ...
        //-----------------------------
        personalAccount.sendKeys("0010000");
        ExpOpen.waitFocusedElem();
        ...
        TakeScreen.TakesScreenshotsSuccess("Save", "Заключения_на_возврат_поступлений_03222");
    ...
    public void DeleteDoc() {
        ...
        TakeScreen.TakesScreenshotsSuccess("Delete", "Заключения_на_возврат_поступлений_03222");
